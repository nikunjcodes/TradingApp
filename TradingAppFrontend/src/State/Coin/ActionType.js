...
export const FETCH_COIN_MARKET_CAP_REQUEST = "FETCH_COIN_MARKET_CAP_REQUEST";
export const FETCH_COIN_MARKET_CAP_SUCCESS = "FETCH_COIN_MARKET_CAP_SUCCESS";
export const FETCH_COIN_MARKET_CAP_FAILURE = "FETCH_COIN_MARKET_CAP_FAILURE";
